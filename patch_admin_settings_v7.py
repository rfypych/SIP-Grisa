...
# Finally the exact block using the div wrapper
old_batas = """            <div className="space-y-2">
...
new_batas = """            <div className="space-y-2">
              <label className="text-sm font-medium text-slate-700 flex items-center gap-2">
...
content = content.replace(old_batas, new_batas)

old_jeda = """            <div className="space-y-2">
              <label className="text-sm font-medium text-slate-700 flex items-center gap-2">
...
new_jeda = """            <div className="space-y-2">
...
content = content.replace(old_jeda, new_jeda)

with open("src/pages/admin/SettingsPage.tsx", "w") as f:
    f.write(content)

print("SettingsPage patched successfully with exact wrapper match!")
